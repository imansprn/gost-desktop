...
data class LogEvent(val serviceId: String, val text: String, val timestamp: Long = System.currentTimeMillis())
        ...
        try {
            ...
            val job = scope.launch {
                ...
                if (ServiceRegistry.getService(serviceId)?.status == ServiceStatus.RUNNING) {
                    ServiceRegistry.updateServiceStatus(serviceId, ServiceStatus.ERROR, errorMessage = "Process exited with code $exitCode")
                }
            }
